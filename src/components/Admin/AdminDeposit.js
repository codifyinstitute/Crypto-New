...
const AdminDeposit = () => {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const response = await fetch('http://147.93.20.176:8000/deposit-transactions/all');
                if (!response.ok) {
    ...
    const handleUpdateStatus = async () => {
        ...
        try {
            const response = await fetch(`http://147.93.20.176:8000/deposit-transactions/put/${selectedTransactionId}`, {
                method: 'PUT',
                headers: {
            ...
            const updatedTransactions = await fetch('http://147.93.20.176:8000/deposit-transactions/all').then(res => res.json());
    ...
    const PaidWallet = async (Id) => {
        try {
            const response = await fetch(`http://147.93.20.176:8000/deposit-transactions/paid/${Id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handelConfirm = async () => {
        if (currentTransaction) {
            ...
            try {
                const response = await fetch(`http://147.93.20.176:8000/deposit-transactions/paid/${transaction._id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    const handelReject = async () => {
        if (currentTransaction) {
            ...
            try {
                ...
                const response = await fetch(`http://147.93.20.176:8000/deposit-transactions/reject/${transaction._id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
