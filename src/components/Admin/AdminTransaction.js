...
const AdminTransaction = () => {
  ...
  const handleConfirmAction = async () => {
    try {
      const url = confirmAction.type === 'accept'
        ? `https://api.moonpayx.com/transactions/complete/${confirmAction.id}`
        : `https://api.moonpayx.com/transactions/reject/${confirmAction.id}`;
  ...
  const handelReject = async (id, value) => {
    try {
      const response = await fetch(`https://api.moonpayx.com/transactions/reject/${id}`, { // Updated URL for the backend
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handelConfirm = async (id, value) => {
    try {
      const response = await fetch(`https://api.moonpayx.com/transactions/complete/${id}`, { // Updated URL for the backend
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
