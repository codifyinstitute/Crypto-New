...
const AdminWithdraw = () => {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const response = await fetch('https://pay.moonpayx.com/withdraw/all');
    ...
    const handleUpdateStatus = async () => {
        ...
        try {
            const response = await fetch(`https://pay.moonpayx.com/withdraw/update/${selectedTransactionId}`, {
                method: 'PUT',
                headers: {
            ...
            const updatedTransactions = await fetch('https://pay.moonpayx.com/withdraw/all').then(res => res.json());
    ...
    const handelReject = async () => {
        ...
        if (currentTransaction) {
            ...
            try {
                const url = `https://pay.moonpayx.com/withdraw/reject/${currentTransaction._id}`;
