...
const AdminWithdraw = () => {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const response = await fetch('http://147.93.20.176:8000/withdraw/all');
    ...
    const handleUpdateStatus = async () => {
        ...
        try {
            const response = await fetch(`http://147.93.20.176:8000/withdraw/update/${selectedTransactionId}`, {
                method: 'PUT',
                headers: {
            ...
            const updatedTransactions = await fetch('http://147.93.20.176:8000/withdraw/all').then(res => res.json());
    ...
    const handelReject = async () => {
        ...
        if (currentTransaction) {
            ...
            try {
                const url = `http://147.93.20.176:8000/withdraw/reject/${currentTransaction._id}`;
