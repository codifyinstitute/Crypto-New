    ...
    const fetchData = async () => {
      try {
        const [currenciesResponse, feesResponse] = await Promise.all([
          axios.get(`https://pay.moonpayx.com/currencies/${countryObject[selectedCountry].urlName}/all`),
          fetch(`https://pay.moonpayx.com/static/${countryObject[selectedCountry]?.urlName}/one`),
        ]);
